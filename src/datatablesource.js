...
export const singleUser = ["username", "email", "city", "country", "phone"];
export const singleHotel = ["name", "type", "city", "address", "distance", "title", "desc", "cheapestPrice"];
export const singleRoom = ["title", "price", "maxPeople", "desc"];
